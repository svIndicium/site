  ...
  <div v-else class="container">
    <div class="head">
      ...
      <div class="rightside">
        ...
        <p>{{ vacancy.email }}</p>
        <div class="buttons">
          <Button v-if="vacancy.url !== ''" :url="vacancy.url" size="l"> Meer info over deze sollicitatie </Button>
          <Button :url="'/partners/' + getPartner(vacancy.partner).slug" size="l"> Bekijk deze partner </Button>
        </div>
      </div>
    </div>
