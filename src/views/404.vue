...
const excuses = [
  ...
  'Mijn code heeft identiteitsproblemen en weet niet meer wie hij is',
  ...
  'De API heeft een bipolaire stoornis en weigert vandaag te werken',
  ...
  'De website is even brak, maar met een reparatie biertje komt het wel goed',
